{
  ...
  c1->SetLogz();
  T->Draw("Time:Ene2>>hist0(600,0,1800,550,-1100,0)","420<tdc2&&tdc2<424","colz");
  ...
  c2->cd(1);
  T->Draw("Time>>hist1(60,-920,-860)","420<tdc2&&tdc2<424&&155<Ene2&&Ene2<165");
  hist1->Fit("gaus","","",-913,-883);
  ...
  c2->cd(2);
  T->Draw("Time>>hist2(60,-920,-860)","420<tdc2&&tdc2<424&&175<Ene2&&Ene2<185");
  hist2->Fit("gaus","","",-915,-890);
  ...
  c2->cd(3);
  T->Draw("Time>>hist3(50,-920,-870)","420<tdc2&&tdc2<424&&195<Ene2&&Ene2<205");
  hist3->Fit("gaus","","",-914,-893);
  ...
  c2->cd(4);
  T->Draw("Time>>hist4(50,-920,-870)","420<tdc2&&tdc2<424&&215<Ene2&&Ene2<225");
  hist4->Fit("gaus","","",-915,-897);
  ...
  c2->cd(5);
  T->Draw("Time>>hist5(40,-920,-880)","420<tdc2&&tdc2<424&&235<Ene2&&Ene2<245");
  ...
  c2->cd(6);
  T->Draw("Time>>hist6(35,-920,-885)","420<tdc2&&tdc2<424&&255<Ene2&&Ene2<265");
  ...
  c2->cd(7);
  T->Draw("Time>>hist7(35,-920,-885)","420<tdc2&&tdc2<424&&275<Ene2&&Ene2<285");
  ...
  c2->cd(8);
  T->Draw("Time>>hist8(35,-920,-885)","420<tdc2&&tdc2<424&&295<Ene2&&Ene2<305");
  ...
  c2->cd(9);
  T->Draw("Time>>hist9(30,-920,-890)","420<tdc2&&tdc2<424&&315<Ene2&&Ene2<325");
  ...
  c2->cd(10);
  T->Draw("Time>>hist10(30,-920,-890)","420<tdc2&&tdc2<424&&335<Ene2&&Ene2<345");
  ...
  c2->cd(11);
  T->Draw("Time>>hist11(30,-920,-890)","420<tdc2&&tdc2<424&&355<Ene2&&Ene2<365");
  ...
  c2->cd(12);
  T->Draw("Time>>hist12(30,-920,-890)","420<tdc2&&tdc2<424&&375<Ene2&&Ene2<385");
  ...
  c2->cd(13);
  T->Draw("Time>>hist13(30,-925,-895)","420<tdc2&&tdc2<424&&395<Ene2&&Ene2<405");
  ...
  c2->cd(14);
  T->Draw("Time>>hist14(30,-925,-895)","420<tdc2&&tdc2<424&&415<Ene2&&Ene2<425");
  ...
  c2->cd(15);
  T->Draw("Time>>hist15(30,-925,-895)","420<tdc2&&tdc2<424&&435<Ene2&&Ene2<445");
  ...
  c2->cd(16);
  T->Draw("Time>>hist16(30,-925,-895)","420<tdc2&&tdc2<424&&455<Ene2&&Ene2<465");
  ...
  c4->SetLogz(1);
  T->Draw("(Time - p_0/pow(Ene2-p_1,p_2) - p_3):Ene2>>hist17(600,0,1800,700,-400,1000)","420<tdc2&&tdc2<424","colz");
  ...
  // output
  TFile *ofile = new TFile("20170223_TQ2.root","RECREATE");
  ...
  for(Int_t ientry = 0 ; ientry < nentry ; ++ientry){
    ...
    TQ_Time = Time - p_0/pow(Ene2-p_1,p_2)-p_3;
